package com.team5.expoapi.security;
...
public class JwtTokenProvider {
  ...
  public String generateToken(Authentication authentication) {
    ...
    return Jwts
      ...
      .setExpiration(
        new Date(
          System.currentTimeMillis() + jwtProperties.getValidityMilis() * 1000
        )
      )
      .compact();
  }
  ...
  UsernamePasswordAuthenticationToken getAuthentication(
    ...
    Collection<GrantedAuthority> authorities = Arrays
      .stream(
        claims.get(jwtProperties.getAuthoritiesKey()).toString().split(",")
      )
